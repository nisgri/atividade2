package br.com.serratec.atividade2.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI myOpenAPI() {
        ...
        contact.setName("Grupo1");
        contact.setUrl("https://www.vendas.com.br");
        ...
        Info info = new Info().title("API de Teste").version("1.0").contact(contact)
                .description("API para testes diversos").termsOfService("https://www.vendas.com.br/termos")
